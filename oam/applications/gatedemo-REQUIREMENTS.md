...
## Acceptance Criteria
The machine-checkable criteria are the fenced ```acceptance blocks under each service above:
- gatedemo-platform/ac-1: The shared realtime substrate declares both raw and aggregate telemetry topics
- gatedemo-ingest/ac-1: Valid HTTP sensor readings are published to the raw telemetry topic
- gatedemo-processor/ac-1: The processor emits rolling averages per sensor
- gatedemo-gateway/ac-1: Browser clients receive aggregate updates over WebSocket
